...
export class UsersManagementPage {
  ...
  enterConfirmationPassword(password = adminUserData.genericPassword) {
  ...
  assertPasswordsDontMatchAlert() {
    this.passwordsDontMatchAlert()
      .should("have.text", "Password didn't match! Try again.")
      .and("be.visible");
  }
  ...
  verifyRegisterFormIsVisible() {
    ...
    this.jobTitleInput().should("be.visible");
    this.passwordInputField().should("be.visible");
    this.passwordConfirmInputField().should("be.visible");
  }
