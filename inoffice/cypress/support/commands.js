...
Cypress.Commands.add("createOfficeApi", (userEmailToAuthenticate, userPassword, officeName, locationName) => {
...
Cypress.Commands.add("getOfficesApi", (userEmailToAuthenticate, userPassword) => {
  cy.getToken(userEmailToAuthenticate, userPassword).as("authToken");
...
Cypress.Commands.add("deleteOfficeApi", (userEmailToAuthenticate, userPassword, officeId) => {
  cy.getToken(userEmailToAuthenticate, userPassword).as("authToken");
